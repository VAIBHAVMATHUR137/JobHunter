...
const CandidateRegistrationPagination: React.FC<PaginationProps> = ({
  currentPage,
  totalPages,
  onSubmit,
}) => {
  ...
  const pages = [
    ...
    "/CandidateConventionalEducation",
    "/CandidateSkillsAndExperience",
    "/CandidatePresent",
  ];
...
export default CandidateRegistrationPagination;

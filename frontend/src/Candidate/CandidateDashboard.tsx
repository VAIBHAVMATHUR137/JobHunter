...
const CandidateDashboard: React.FC = () => {
  ...
  // Render dashboard only if candidate data is available
  if (!candidateData) {
    return null;
  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-primary/5 rounded-lg hover:bg-primary/10 transition-colors duration-200">
                    ...
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      {candidateData.current_job.years_of_experience} years
                      experience
                    </span>
                  </div>
                </div>
        ...
        <Tabs defaultValue="Education" className="mt-8">
            ...
            <Card className="shadow-lg border-t-4 border-t-primary">
              ...
              <CardContent>
                <div className="space-y-8">
                  {candidateData.college_education
          ...
          <TabsContent value="Certificate">
            <Card className="shadow-lg border-t-4 border-t-primary">
              ...
              <CardContent>
                <div className="space-y-8 ">
                  {candidateData.certificate_courses
          ...
          <TabsContent value="Internship">
            <Card className="shadow-lg border-t-4 border-t-primary">
              ...
              <CardContent>
                <div className="space-y-8 ">
                  {candidateData.internship_experience

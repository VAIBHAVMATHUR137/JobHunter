...
function CandidateSkillsAndExperience() {
  ...
  const states = useSelector((state: RootState) => ({
    internshipExperience: state.candidateRegister.internship_experience,
    certificateCourses: state.candidateRegister.certificate_courses,
    workExperience: state.candidateRegister.work_experience,
    coreSkills: state.candidateRegister.core_skills,
  }));
    ...
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 p-6">
        <Card className="w-full max-w-4xl shadow-lg">
          ...
          <CardFooter>
            <CandidateRegistrationPagination currentPage={3} totalPages={4} />
          </CardFooter>
        </Card>
      </div>
    </>
...
export default CandidateSkillsAndExperience;
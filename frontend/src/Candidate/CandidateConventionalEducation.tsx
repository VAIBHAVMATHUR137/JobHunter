...
const CandidateEducationForm = () => {
  ...
  const SCHOOL_FORM_FIELDS: EducationFormField[] = [
    {
      ...
      type: "text",
      placeholder: "e.g KDB Public School",
    },
    {
      id: "school_board",
      label: "Enter your School Board",
      type: "text",
    ...
    },
    {
      ...
      type: "text",
      placeholder: "e.g 91.89. Do not enter % symbol",
    },
    {
      id: "year_of_passing",
  ...
  const COLLEGE_FORM_FIELD: EducationFormField[] = [
    {
      ...
      type: "text",
      placeholder: "e.g Bachelor of Technology or Masters of Engineering",
    },
    {
      id: "specialization",
      label: "Enter Specialization",
      type: "text",
      placeholder: "e.g Finance or Human Resources or Structural",
    },
    {
      id: "college_name",
    ...
    },
    {
      ...
      type: "text",
      placeholder: "e.g Anna University or Manipal University",
    },
    {
      id: "cgpa",
      label: "Enter CGPA you scored",
      type: "text",
      placeholder: "Enter non decimal values out of 10",
    },
    {
      id: "duration",
      label: "Enter the Course Duration",
      type: "text",
      placeholder: "Enter duration in months in form of numeric input only",
    },
    {
      id: "year_of_commencement",
  ...
  const schoolEducationData = useSelector((state: RootState) => ({
    tenth: state.candidateRegister.tenth_standard_education,
    twelth: state.candidateRegister.twelth_standard_education,
  }));
  const collegeEducationData = useSelector((state: RootState) => ({
    college: state.candidateRegister.college_education,
  }));
    ...
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 p-6">
        <Card className="w-full max-w-4xl shadow-lg">
          ...
          <CardFooter>
            <CandidateRegistrationPagination currentPage={2} totalPages={4} />
          </CardFooter>
        </Card>
      </div>
    </>

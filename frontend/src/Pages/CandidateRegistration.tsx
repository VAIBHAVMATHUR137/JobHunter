...
const basicFormFields = [
  "name", "email", "number", "password", "current_location", 
  "degree", "college_name", "college_tier", "notice_period", 
  "years_of_experience", "github", "xProfile", "linkedin", "portfolio"
] as const
...
const locationFields = [
  "firstPreferrence", "secondPreferrence", "thirdPreferrence"
] as const
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      if (response.status === 201) {
        // Reset form logic remains the same as in your original component
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader>
          <CardTitle className="text-center">Candidate Registration</CardTitle>
